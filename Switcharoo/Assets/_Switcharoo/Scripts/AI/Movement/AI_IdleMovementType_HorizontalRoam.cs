...
public class AI_IdleMovementType_HorizontalRoam : AI_IdleMovementType_Base
{
    ...
    {
        m_movementType.MoveToPosition(p_aiController,p_aiController.m_idleSpeed, p_rb, p_agent, p_enemyObject.position, (p_enemyObject.right * p_forwardDir) + p_enemyObject.position,p_isGrounded);
    }
}
